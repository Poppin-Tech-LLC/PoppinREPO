...
final class EventAnnotationView: MKAnnotationView {
    ...
    public static let defaultEventAnnotationViewReuseIdentifier = "EventAnnotationView"
    ...
    func setEventAnnotation(eventAnnotation: EventAnnotation) {
        ...
        popsicleIconImageView.image = eventAnnotation.category.getPopsicleIcon256()
        popsicleIconShadowImageView.image = eventAnnotation.category.getPopsicleShadow256()
